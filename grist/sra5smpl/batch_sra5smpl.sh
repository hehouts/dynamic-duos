...
#SBATCH --mem=12G
#SBATCH -c 1
#SBATCH -e jobs/sra5.j%j.err
#SBATCH -o jobs/sra5.j%j.out
...
genome-grist run config_sra5smpl.yml summarize_mapping --rerun-incomplete  -j1 --latency-wait 180 --keep-going
